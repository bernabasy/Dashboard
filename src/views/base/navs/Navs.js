      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          ...
          <p className="text-medium-emphasis small">
            ...
            <code>&lt;ol&gt;</code>
            {' '}
            if the order of your items is important, or
            roll your own with a
            <code>&lt;nav&gt;</code>
            {' '}
            element. Because the
            .nav uses display: flex, the nav links behave the same as nav items
      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            ...
            {' '}
            utility. Need to stack them on some
      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            ...
            . Notice that all horizontal space
