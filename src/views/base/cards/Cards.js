      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          ...
          <p className="text-medium-emphasis small">
            ...
            <code>&lt;CCardBody&gt;</code>
            {' '}
            item, the card title, and subtitle
      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            ...
            {' '}
            places a picture to the top of the card.
            With
            <code>.card-text</code>
            , text can be added to the card. Text
            within
            <code>.card-text</code>
            {' '}
            can additionally be styled with the
            regular HTML tags.
          </p>
      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          ...
          <p className="text-medium-emphasis small">
            ...
            <code>&lt;CCard&gt;</code>
            {' '}
            or a subset of the card&#39;s contents as
            shown below.
          </p>
      ...
      <CCard className="mb-4">
        ...
        <CCardBody>
          <p className="text-medium-emphasis small">
            ...
            {' '}
            to become attached with uniform
            dimensions starting at the
            {' '}
            <code>sm</code>
            {' '}
            breakpoint.
